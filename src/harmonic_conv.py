...
__all__ = ["SingleHarmonicConv2d", "SingleLogHarmonicConv2d","SingleHarmonicConv2d_tf", "SingleLogHarmonicConv2d_tf"]
...
class SingleHarmonicConv2d_tf(BaseSingleHarmonicConv2d_tf):
    """
    Harmonic Convolution by Harmonic Lowering
    """
...
class SingleLogHarmonicConv2d_tf(BaseSingleHarmonicConv2d_tf):
    def __init__(self, *args, out_log_scale=1000, in_log_scale=0.001, radix=None, **kwargs):
        super().__init__(*args, **kwargs)
